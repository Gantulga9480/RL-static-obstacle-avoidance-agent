...
import numpy as np
from pyrl.ppo import ProximalPolicyOptimizationAgent as PPO
from env import Environment, STATE_SPACE_SIZE, ACTION_SPACE_SIZE
...
agent = PPO(STATE_SPACE_SIZE, ACTION_SPACE_SIZE, device=DEVICE)
